...
if data ==  main:
    get_files("C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/Brain Seg Data Oasis top view/Actual Data/loaded arrays",
              save_folder_path = "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/Brain Seg Data Oasis top view/Actual Data/loaded arrays/Images and Masks For Tumor Segmentation")
