...
for Set in range(start, len(sets)):
    ...
    write_images(np.stack([flair,t1,t2],axis=-1), output_image_path)
    write_images(np.stack([flair,t1,t2],axis=-1), output_image_path+"/treatment response testing/"+str(Set)+"b/image_full")
    ...
    write_images(binary_brain_final_combined, output_image_path+"/treatment response testing/"+str(Set)+"b/imageblub")
    ...
    t2 /=(find_median_grayscale(t2)/0.2)
    flair /=(find_median_grayscale(flair)/0.2)
    write_images(np.stack([flair,t1,t2],axis=-1), output_image_path+"/treatment response testing/"+str(Set)+"b/image_brain")
    ...
    write_images(only_brain, output_image_path+"/treatment response testing/"+str(Set)+"b/imagebraib")
    ...
    print(np.max(tumor_colored))
    tumor_colored = np.round(tumor_colored*3)
    write_images(tumor_colored/3, output_image_path+"/treatment response testing/"+str(Set)+"b/image_seg")
    tumor_colored[tumor_binary == 0] = 0
    write_images(tumor_colored/3, output_image_path+"/treatment response testing/"+str(Set)+"b/image_seg_bin")
    tumor_colored = skimage.transform.rescale(tumor_colored/3, (0.5,0.5,0.5))
    print(np.max(tumor_colored))
    tumor_colored = np.round(tumor_colored*3)
    print(tumor_colored.shape)
    ...
    open(output_image_path+"/treatment response testing/"+str(Set)+"b/response","w+").write(str(response))

    #-----------------------------------------------------------------------------------------------------------------------------------------


    complete_image = np.stack([old_image[:,:,:,0],old_image[:,:,:,1],old_image[:,:,:,2],old_image[:,:,:,3],old_image[:,:,:,4],old_image[:,:,:,5],
                               new_image[:,:,:,0],new_image[:,:,:,1],new_image[:,:,:,2],new_image[:,:,:,3],new_image[:,:,:,4],new_image[:,:,:,5],interval,age],axis = -1)
