...
output_image_path = "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/image ct  visualizations/Machine Learning 2 models test/Brain Seg OASIS 36 top view image 2 (win) translated with edges precise"
...
path= "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/TCGA and Tumor progression combined"
...
image_size = 128
index = 0
file = get_folder_path("C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/Brain-Tumor-Progression", index, "t1prereg")
...
binary_brain_area1 = binarize(brain_mask1, 0.9)
...
new_array = only_brain/(median/0.4)
