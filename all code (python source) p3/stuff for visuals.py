...
for Set in range(start, len(sets)):
    ...
    print(sets[Set])
    print("blub:",pathes)
    [flair,t1,t2,adc],factor = preprocess_data_set(sets[Set][0])
    ...
    write_images(cflair, output_image_path+"/tumor growth pred/"+str(Set)+"/bran1")
    write_images(ct1, output_image_path+"/tumor growth pred/"+str(Set)+"/bran2")
    write_images(ct2, output_image_path+"/tumor growth pred/"+str(Set)+"/bran3")

    write_images(bflair, output_image_path+"/tumor growth pred/"+str(Set)+"/bbran1")
    write_images(bt1, output_image_path+"/tumor growth pred/"+str(Set)+"/bbran2")
    write_images(bt2, output_image_path+"/tumor growth pred/"+str(Set)+"/bbran3")
    ...
    adc /=(find_median_grayscale(adc)/0.35)
    ...
    write_images(tumor_mask[:,:,:,1], output_image_path+"/tumor growth pred/"+str(Set)+"/tum1")
    write_images(tumor_mask[:,:,:,2], output_image_path+"/tumor growth pred/"+str(Set)+"/tum2")
    write_images(tumor_mask[:,:,:,3], output_image_path+"/tumor growth pred/"+str(Set)+"/tum3")
    write_images(tumor_mask[:,:,:,1]+tumor_mask[:,:,:,2]+tumor_mask[:,:,:,3], output_image_path+"/tumor growth pred/"+str(Set)+"/tum4")
    write_images(np.stack([tumor_mask[:,:,:,1],tumor_mask[:,:,:,2],tumor_mask[:,:,:,3]],axis=-1), output_image_path+"/tumor growth pred/"+str(Set)+"b/tum5")
    ...
    write_images(cflair, output_image_path+"/tumor growth pred/"+str(Set)+"/bran1a")
    write_images(ct1, output_image_path+"/tumor growth pred/"+str(Set)+"/bran2a")
    write_images(ct2, output_image_path+"/tumor growth pred/"+str(Set)+"/bran3a")


    write_images(bflair, output_image_path+"/tumor growth pred/"+str(Set)+"/bbran1a")
    write_images(bt1, output_image_path+"/tumor growth pred/"+str(Set)+"/bbran2a")
    write_images(bt2, output_image_path+"/tumor growth pred/"+str(Set)+"/bbran3a")
    ...
    print("saved mask\n")
    write_images(image[:,:,:,0], output_image_path+"/tumor growth pred/"+str(Set)+"/image1")
    write_images(image[:,:,:,1], output_image_path+"/tumor growth pred/"+str(Set)+"/image2")
    write_images(image[:,:,:,2], output_image_path+"/tumor growth pred/"+str(Set)+"/image3")
    write_images(image[:,:,:,3], output_image_path+"/tumor growth pred/"+str(Set)+"/image4")'''
    ...
    [flair,t1,t2,adc],factor = preprocess_data_set(sets[Set][1])
    ...
    write_images(cflair, output_image_path+"/tumor growth pred/"+str(Set)+"b/bran1")
    write_images(ct1, output_image_path+"/tumor growth pred/"+str(Set)+"b/bran2")
    write_images(ct2, output_image_path+"/tumor growth pred/"+str(Set)+"b/bran3")

    write_images(bflair, output_image_path+"/tumor growth pred/"+str(Set)+"b/bbran1")
    write_images(bt1, output_image_path+"/tumor growth pred/"+str(Set)+"b/bbran2")
    write_images(bt2, output_image_path+"/tumor growth pred/"+str(Set)+"b/bbran3")
    ...
    tumor_mask[:,:,:,1]-=tumor_mask[:,:,:,2]
    tumor_mask[:,:,:,1]-=tumor_mask[:,:,:,3]'''
    write_images(tumor_mask[:,:,:,1], output_image_path+"/tumor growth pred/"+str(Set)+"b/tum1")
    write_images(tumor_mask[:,:,:,2], output_image_path+"/tumor growth pred/"+str(Set)+"b/tum2")
    write_images(tumor_mask[:,:,:,3], output_image_path+"/tumor growth pred/"+str(Set)+"b/tum3")
    write_images(tumor_mask[:,:,:,1]+tumor_mask[:,:,:,2]+tumor_mask[:,:,:,3], output_image_path+"/tumor growth pred/"+str(Set)+"b/tum4")
    write_images(np.stack([tumor_mask[:,:,:,1],tumor_mask[:,:,:,2],tumor_mask[:,:,:,3]],axis=-1), output_image_path+"/tumor growth pred/"+str(Set)+"b/tum5")
    ...
    write_images(cflair, output_image_path+"/tumor growth pred/"+str(Set)+"b/bran1a")
    write_images(ct1, output_image_path+"/tumor growth pred/"+str(Set)+"b/bran2a")
    write_images(ct2, output_image_path+"/tumor growth pred/"+str(Set)+"b/bran3a")
