...
binary_brain_area12 = brain.erode_down(binary_brain_area1, 2)
...
binary_brain_area13 = combine_zeros(binary_brain_area1, binary_brain_area12)
...
brain_seged_extra[brain_mask_precise_rescaled == 0] = 0

brain_seged_extra = brain_seged_extra/(median/0.2)
...
adapted = adaptive_threshold(original_unscaled_array, 101, 101)
...
circled = circle_highlighted(original_unscaled_array, no_brain, 0.8)
