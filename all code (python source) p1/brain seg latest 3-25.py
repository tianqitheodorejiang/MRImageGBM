...
area_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 13/Model 41"
brain_seg_model_area = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 34"
brain_seg_model_precise = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 1"
...
binary1 = binarize(tumor_mask2, 0.3)


brain_seg_area[binary1 == 0] = 0
...
binary2 = binarize(tumor_mask1, 0.1)


circled = circle_highlighted(original_array, binary2, 1)


write_images(brain_seg_area, output_image_path)
