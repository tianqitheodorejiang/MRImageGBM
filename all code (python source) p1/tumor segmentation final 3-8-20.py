...
brain_seg_pinpoint = keras.models.load_model(brain_seg_model_precise)
...
final_brain_area = brain_seg_array_area/np.max(brain_seg_array_area)
...
correct = touching_island(precise_tumor_binary, tumor_area_binary)
