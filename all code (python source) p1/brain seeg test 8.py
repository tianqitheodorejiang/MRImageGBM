...
brain_seg_area1 = keras.models.load_model(brain_seg_model_area2)

brain_prediction_area1 = brain_seg_area1.predict(original_array)

binary_brain_area2 = binarize(brain_prediction_area1, 0.1)

brain_seg_area1 = keras.models.load_model(brain_seg_model_area1)

brain_prediction_area1 = brain_seg_area1.predict(original_array)

binary_brain_area1 = binarize(brain_prediction_area1, 0.5)

final_brain_area_binary = combine_zeros(binary_brain_area1,binary_brain_area1) 

final_brain_area_binary = kill_small_islands(final_brain_area_binary, 1)

final_brain_area_binary = dilate_up(final_brain_area_binary, blank, 1)
...
final_brain_area2 = original_array.copy()


#####

final_brain_area2[binary_brain_area1 == 0] = 0

#####



final_brain_area = final_brain_area/np.max(final_brain_area2)
...
precision_area = combine_white_binary(comed, area_binary4)
...
binary_brain_area1 = binarize(brain_prediction_area1, 0.1)

final_brain_area_binary = binary_brain_area1 
...
precise = combine_zeros(final_brain_area_binary, precision_area)

precise = dilate_up(precise, blank, 1)


correct = touching_island(precise, area)

#original_array[final_brain_area == 0] *= 0.5

circled = circle_highlighted(original_array, area, 1)
