...
original_array = correct_rotation_z_axis(original_array, original_array12)
...
correct = branch(correct1, adapted, 20)

combined = combine_zeros(correct, tumor_parts)



circled = circle_highlighted(original_array, brain_seg_array, 1)
