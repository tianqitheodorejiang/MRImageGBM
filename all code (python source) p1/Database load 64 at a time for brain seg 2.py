...
def get_files(path, img_id = "flair", save_folder_path = None, chunk_size = 64, image_size = 128):
    images = []
    masks = []
    start_time = time.time()
        ...
        for dir_ in dirs:
            if img_id in dir_.lower():
                try:
                    ...
                    masks.append(binary_brain_area12)
                except:
                     print("FAILED")
...
if data ==  main:
    get_files("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/TCGA GBM DATA", img_id = "flair",
