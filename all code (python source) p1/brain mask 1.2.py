...
binary_brain_area1 = binarize(brain_mask1, 0.99)
...
binary_brain_area3 = binarize(brain_mask1, 0.8)
...
brain_mask_area = dilate_up(brain_mask_area1, blank, 5)
...
new_array = brain_seged/(median/0.2)
...
non_tumor_brain = combine_zeros(non_tumor, brain_mask_precise_rescaled)

adapted = adaptive_threshold(non_tumor_brain, 45, 45, 2)

adapted = combine_white_binary(adapted, precise_tumor_binary_rescaled)



brain_mask = combine_zeros(adapted, brain_mask_precise_rescaled)

brain_mask1 = kill_small_islands(brain_mask, 2)


brain_mask12 = branch(brain_mask1, adapted, 3)





circled1 = circle_highlighted(original_unscaled_array, brain_mask12, 0.8)
#circled2 = circle_highlighted(original_array, binary_brain_precise, 0.8)


write_images(circled1, output_image_path)
write_images(brain_mask, output_image_path_Seg)
write_images(brain_mask1, output_image_path_Seg2)
write_images(brain_mask12, output_image_path_Seg3)

brain.generate_stl(brain_mask12.T, "/home/jiangl/Documents/python/ct to tumor identifier project/3d stl ct visualizations", "brain new.stl", 1)
