...
binary_brain_area = binarize(brain_prediction_area, 0.15)
...
binary_brain_precise = binarize(brain_prediction_precise, 0.4)
...
final_brain_area = brain_seg_area/np.max(brain_seg_pinpoint)
...
tumor_area_binary = combine_white_binary(area_binary1, precise_tumor_binary)
tumor_area_binary = combine_white_binary(tumor_area_binary, area_binary2)
...
circled = circle_highlighted(original_array, correct_tumor_binary, 1)
