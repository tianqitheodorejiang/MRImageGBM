...
precise_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 6"
...
brain_seg_model_precise2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 4"
...
binary_brain_area1 = binarize(brain_mask2_precise1, 0.99)

binary_brain_area2 = binarize(brain_mask2_precise2, 0.6)




#binary_brain_area1 = combine_white_binary(binary_brain_area1, binary_brain_area2)
binary_brain_area1 = combine_zeros(binary_brain_area1, binary_brain_area12)
...
#adapted = brain.threshold_scans(adapted, 0.05, 1, 1)

brain_mask_precise_rescaled = dilate_up(brain_mask_precise_rescaled, blank, 1)

brain_mask_precise_rescaled = combine_zeros(brain_mask_precise_rescaled, adapted)

brain_mask_precise_rescaled = kill_small_islands(brain_mask_precise_rescaled, 1)

seged = original_unscaled_array.copy()

seged[brain_mask_precise_rescaled == 0] = 0

threshed3 = brain.threshold_scans(seged, 0.05, 1, 2)


circled = circle_highlighted(original_unscaled_array, brain_mask_precise_rescaled, 0.8)


write_images(adapted, output_image_path)
