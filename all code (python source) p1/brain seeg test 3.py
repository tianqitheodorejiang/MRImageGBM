...
precise_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/True area/Model 10"
...
binary_brain_precise = binarize(brain_mask, 0.1)
...
precise_binary_tumor = binarize(precise_prediction, 0.1)


circled = circle_highlighted(original_array, precise_binary_tumor, 1)

#circled = circle_highlighted(circled, binary_brain_precise, 1)
