...
area_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 17/Model 11"
brain_seg_model2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 2"
brain_seg_model1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 34"
...
brain_seg = keras.models.load_model(brain_seg_model2)

brain_mask = brain_seg.predict(brain_seg_array_area)

binary_brain_area1 = binarize(brain_mask, 0.9)
...
circled = circle_highlighted(original_array, binary_brain_area1 , 1)
