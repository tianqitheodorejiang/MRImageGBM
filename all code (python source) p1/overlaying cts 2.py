...
#    plt.show()
 ...
 #   plt.imshow(back_rotated_reference)
 #   plt.show()
 #   plt.imshow(rotation_original)
 #   plt.show()
...
def correct_rotation_z_axis(array, reference_array):
    ...
    #flat_z_axis_reference = flat_z_axis_reference/binary_reference.shape[0]
    #flat_z_axis_average_array = flat_z_axis_average_array/binary_array.shape[0]

    plt.imshow(flat_z_axis_average_array)
    plt.show()
    plt.imshow(flat_z_axis_reference)
    plt.show()
    ...
    for i in range(0,360):
        ...
        #rangE = np.count_nonzero(eliminated)
