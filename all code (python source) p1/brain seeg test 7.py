...
area_model_path2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/True area/Model 8"
...
binary_brain_precise1 = binarize(brain_prediction_precise, 0.1)
...
brain_seg_array_precise[binary_brain_precise3 == 0] = 0

brain_seg_array_precise = brain_seg_array_precise/np.max(brain_seg_array_precise)

brain_seg_array_precise = kill_small_islands(brain_seg_array_precise, 2)
...
precise_tumor_binary = binarize(precise_prediction, 0.5)
...
binary_brain_area2 = binarize(brain_prediction_area2, 0.1)
...
final_brain_area_binary = kill_small_islands(final_brain_area_binary, 5)

final_brain_area_binary = dilate_up(final_brain_area_binary, blank, 4)
...
precise_tumor_binary = combine_white_binary(precise_tumor_binary, area_binary2)
