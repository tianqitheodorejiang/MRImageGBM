...
skull_seg_model = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 43"
...
brain_seged[binary_brain_area2 == 0] *= 3



brain_seg = keras.models.load_model(skull_seg_model)
...
adapted = binarize(original_array, 0.3)

binary_array = combine_zeros(adapted, binary_brain_area2)



binary_array = kill_small_islands(binary_array, 2)



#binary_brain_area1 = kill_small_islands(binary_brain_area1, 1)

#binary_brain_area1 = combine_white_binary(binary_brain_area1, binary_brain_precise)
