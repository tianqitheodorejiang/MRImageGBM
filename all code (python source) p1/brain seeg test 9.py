...
binary_brain_area1 = binarize(brain_prediction_area1, 0.3)
...
binary_brain_area2 = binarize(brain_prediction_area2, 1)


brain_seg_area21 = keras.models.load_model(brain_seg_model_area1)

brain_prediction_area21 = brain_seg_area21.predict(original_array)

binary_brain_area21 = binarize(brain_prediction_area21, 0.2)
