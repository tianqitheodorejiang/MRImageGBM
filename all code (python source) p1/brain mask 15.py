...
brain_seged = brain_seged/(median/2)

median = find_median_grayscale(brain_seged)

precise_model = keras.models.load_model(area_model_path1)
...
circled = circle_highlighted(original_array, precise_tumor_binary, 0.8)
