...
area_model_path4 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 17/Model 21"
brain_seg_model_precise = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 32"
brain_seg_model_area = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 2"
...
brain_prediction_precise = brain_seg.predict(original_array)

binary_brain_precise = binarize(brain_prediction_precise, 0.1)
...
precise_binary_tumor = binarize(precise_prediction, 1)
...
binary_brain_area = original_array.copy()


brain_seg_array_area[binary_brain_area == 0] = 0

killed = kill_small_islands(binary_brain_precise, 1)


brain_seg_array_precise[killed == 0] = 0
...
brain_seg_array_area = brain_seg_array_area/np.max(brain_seg_array_precise)
...
correct = touching_island(precise_binary, comed)



branched = branch(correct, adapted, 1)
...
circled = circle_highlighted(original_array, binary_brain_precise, 0.5)
