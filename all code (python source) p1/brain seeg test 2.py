...
area_model_path1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 17/Model 11"
...
area_model_path4 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 6"
...
binary_brain_precise = binarize(brain_mask, 0.99)
...
killed = kill_small_islands(binary_brain_area, 1)


brain_seg_array_area[killed == 0] = 0




adapted = adaptive_threshold(brain_seg_array_area, 7, 25, 1)

binary = binarize(adapted, 0.5)

brain_seg_array_area = brain_seg_array_area/np.max(brain_seg_array_area)

precise_model = keras.models.load_model(precise_model_path)

precise_prediction = precise_model.predict(brain_seg_array_area)

precise_binary = binarize(precise_prediction, 1)
...
area_prediction1 = area_model1.predict(brain_seg_array_area)
...
area_prediction2 = area_model2.predict(brain_seg_array_area)
...
area_prediction3 = area_model3.predict(brain_seg_array_area)
...
area_prediction4 = area_model4.predict(brain_seg_array_area)
...
comed = combine_white_binary(area_binary1, precise_binary)
...
branched = branch(killed, adapted, 1)
...
dilate = dilate_up(branched, original_array, 1)

com = combine_zeros(dilate, binary)

circled = circle_highlighted(original_array, comed, 1)

#circled = circle_highlighted(circled, killed, 0.5)
