...
binary_brain_area2 = binarize(brain_mask2_precise1, 0.99)
...
brain_median = find_median_grayscale(brain_seg_area)
...
tumorless_array[brain_mask_precise_rescaled == 0] *= 1


tumorless_array = np.squeeze(tumorless_array.copy()[0], axis = 3)

tumorless_array = tumorless_array/(brain_median/0.5)
...
#write_images(brain_mask2_precise1, output_image_path_Seg)
