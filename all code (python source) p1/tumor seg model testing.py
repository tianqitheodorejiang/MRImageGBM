...
models_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 17"
...
images_path = os.path.join(models_path + "/images")
...
for model in model_list:
    ...
    tumor_seg = keras.models.load_model(model_path)

    tumor_mask = tumor_seg.predict(brain_seg_array_area)



    write_images(tumor_mask, model_images_path)
