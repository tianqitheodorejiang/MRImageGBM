...
brain_seg_model_precise1 = "/home/jiangl/Downloads/Saved brain seg/Model 22.h5"
...
new_array = original_array/(median/0.1)

brain_mask1 = brain_seg.predict(new_array)

binary_brain_area1 = binarize(brain_mask1, 0.9)

binary_brain_area1 = dilate_up(binary_brain_area1, blank, 1)

binary_brain_area1 = fill_holes(binary_brain_area1, 1000000000)

binary_brain_area1 = np.squeeze(binary_brain_area1.copy()[0], axis = 3)


binary_brain_area1 = np.rot90(binary_brain_area1, axes = (0,1))
binary_brain_area1 = np.rot90(binary_brain_area1, axes = (0,1))
...
original_array = np.squeeze(original_array.copy()[0], axis = 3)


original_array = np.rot90(original_array, axes = (0,1))
original_array = np.rot90(original_array, axes = (0,1))

original_array = np.stack([np.stack([original_array], axis = 3)])
...
binary_brain_area1 = binarize(brain_mask1, 0.4)
...
binary_brain_area1 = binarize(brain_mask1, 0.1)


brain_seg = keras.models.load_model(brain_seg_model_precise3)

new_array1 = original_array/(median/0.2)
new_array2 = original_array/(median/0.05)

brain_mask1 = brain_seg.predict(new_array1)
brain_mask2 = brain_seg.predict(new_array2)

binary_brain_area21 = binarize(brain_mask1, 0.4)
binary_brain_area22 = binarize(brain_mask2, 0.4)


binary_brain_area1 = combine_white_binary(binary_brain_area1, binary_brain_area21)
...
new_array = brain_seged/(median/0.15)

brain_mask1 = brain_seg.predict(new_array)

binary_brain_area11 = binarize(brain_mask1, 0.15)

binary_brain_area11 = combine_zeros(binary_brain_area11, binary_brain_area22)


mask_upscaled = skimage.transform.rescale(np.squeeze(binary_brain_area11.copy()[0], axis = 3), (backscale_factor, backscale_factor, backscale_factor))
...
mask = combine_zeros(brain_mask_precise_rescaled, brain_mask_area_rescaled)
...
binary_brain_area1 = binarize(brain_mask1, 0.05)
...
new_array1 = brain_seged/(median/0.1)


brain_mask1 = brain_seg.predict(new_array1)

binary_brain_area11 = binarize(brain_mask1, 0.6)


brain_seg = keras.models.load_model(brain_seg_model_area)

new_array1 = brain_seged/(median/0.05)
new_array2 = brain_seged/(median/0.2)


brain_mask1 = brain_seg.predict(new_array1)
brain_mask2 = brain_seg.predict(new_array2)

binary_brain_area121 = binarize(brain_mask1, 0.35)
binary_brain_area122 = binarize(brain_mask2, 0.35)
                               
binary_brain_area12 = combine_zeros(binary_brain_area121, binary_brain_area122)





mask_upscaled = skimage.transform.rescale(np.squeeze(binary_brain_area12.copy()[0], axis = 3), (backscale_factor, backscale_factor, backscale_factor))
...
original_unscaled_array_new = original_unscaled_array/(median/0.2)
...
adapted = adaptive_threshold(original_unscaled_array, 11, 45, 1)

brain_mask = combine_zeros(mask, adapted)

brain_mask = combine_white_binary(brain_mask, brain_mask_precise_rescaled)


brain_mask = kill_small_islands(brain_mask, 3)



circled = circle_highlighted(original_unscaled_array, brain_mask, 0.8)



#circled = circle_highlighted(original_array, binary_brain_area1, 0.8)
