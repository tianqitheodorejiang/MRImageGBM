...
brain_seg_model_precise3 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 3"
brain_seg_model_precise4 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 4"
...
print("\n\nSet:", index, "\n\n")
#"/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/TCGA GBM DATA/8.000000-T2 FLAIR-2MM-74210"
...
binary_brain_area11 = combine_zeros(binary_brain_area11, binary_brain_area12)
...
brain_mask_precise_rescaled = kill_small_islands(brain_mask_precise_rescaled, 1)

'''
def_all_skull = brain.invert(brain_mask_precise_rescaled)

adapted = adaptive_threshold(original_unscaled_array_new, 11, 45, 1)

threshed = binarize(original_unscaled_array_new, 0.1)

adapted = combine_zeros(adapted, threshed)

def_all_skull = combine_zeros(def_all_skull, adapted)

def_all_skull = kill_small_islands(def_all_skull, 2)
'''
