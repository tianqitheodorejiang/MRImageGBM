...
brain_seg_model = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/True area/Model 4"
...
adapted = adaptive_threshold(original_array,5,25,1)
...
circled = circle_highlighted(original_array, binary_brain, 1)
