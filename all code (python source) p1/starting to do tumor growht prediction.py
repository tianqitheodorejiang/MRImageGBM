...
brain_seg_model = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 33"
...
def cast_bounding(array, wanted_bounds, current_bounds):
    ...
    translate_x = left_wanted-left_rescaled
    translate_y = low_wanted-low_rescaled
    translate_z = shallow_wanted-shallow_rescaled
