...
precise_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 17/Model 11"
...
area_model_path3 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 17/Model 11"
area_model_path4 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 103"
...
brain_seg_model_area2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 2"
brain_seg_model_area1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 34"
...
binary_brain_area1 = binarize(brain_prediction_area1, 0.15)


#binary_brain_area2 = combine_zeros(binary_brain_area2, binary_brain_area21)

#final_brain_area_binary = combine_white_binary(binary_brain_area1, binary_brain_area2)

final_brain_area = original_array.copy()

final_brain_area[binary_brain_area1 == 0] = 0



brain_seg_precise = keras.models.load_model(brain_seg_model_area2)

brain_prediction_precise = brain_seg_precise.predict(original_array)

binary_brain_precise = binarize(brain_prediction_precise, 1)

final_brain_precise = original_array.copy()

final_brain_precise[binary_brain_precise == 0] = 0


######################################################################################################################################


final_brain_area = final_brain_area/np.max(final_brain_precise)

precise_model = keras.models.load_model(precise_model_path)

precise_tumor_prediction = precise_model.predict(final_brain_area)

area_tumor_binary = binarize(precise_tumor_prediction, 1)
...
area_binary3 = binarize(area_prediction3, 1)
...
area_binary4 = binarize(area_prediction4, 1)
...
#final_tumor_area = original_array.copy()

#final_tumor_area[comed == 0] = 0


#adapted = adaptive_threshold(final_tumor_area, 15, 45, 0)

#comed = brain.erode_down(adapted, 2)

correct = touching_island(area_tumor_binary, comed)
