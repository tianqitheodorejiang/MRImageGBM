...
brain_seg = original_unscaled_array.copy()

brain_seg[brain_mask_precise_rescaled == 0] = 0

threshed = binarize(brain_seg, 0.05)

actual_brain = kill_small_islands(threshed, 2)

circled = circle_highlighted(original_unscaled_array, actual_brain, 0.8)
