...
regrayed_array = np.squeeze(original_array.copy()[0], axis = 3)*(0.11/median)
median = find_median_grayscale(regrayed_array)
print("brain median:" + str(median))

# `prob` will be a 3d numpy image containing probability 
# of being brain tissue for each of the voxels in `img`
prob = ext.run(regrayed_array) 
