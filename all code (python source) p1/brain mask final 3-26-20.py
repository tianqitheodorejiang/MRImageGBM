...
binary_brain_area = binarize(brain_mask1, 0.2)
...
binary_brain_final = combine_white_binary(binary_brain_area, binary_brain_area2)
...
print("seged_max:", np.max(brain_seg_area_final))


brain_seg_area_final = brain_seg_area_final/np.max(brain_seg_area_final)

print("seged_median:", find_median_grayscale(brain_seg_area_final))

binary_brain_precise = binarize(brain_mask1, 0.3)




binary_precise = combine_zeros(binary_brain_precise, binary_brain_area2)





brain_branch = binarize(brain_mask2, 1)


adapted = adaptive_threshold(original_array, 71,51, 0)

binary_array = combine_zeros(adapted, binary_brain_area)


binary_array = combine_white_binary(binary_array, binary_precise)


binary_array = kill_small_islands(binary_array, 1)
