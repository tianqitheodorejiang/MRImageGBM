...
brain_seg_model_area1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 11"
brain_seg_model_area2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 3"
brain_seg_model_area3 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 34"
...
brain_seg = keras.models.load_model(brain_seg_model_area1)

brain_mask = brain_seg.predict(original_array)

binary_brain_area1 = binarize(brain_mask, 0.8)




brain_seg = keras.models.load_model(brain_seg_model_area2)

brain_mask = brain_seg.predict(original_array)

binary_brain_area2 = binarize(brain_mask, 0.95)



brain_seg = keras.models.load_model(brain_seg_model_area3)

brain_mask = brain_seg.predict(original_array)

binary_brain_area3 = binarize(brain_mask, 0.2)


binary_brain_final = combine_white_binary(binary_brain_area1, binary_brain_area3)
binary_brain_final = combine_white_binary(binary_brain_final, binary_brain_area3)



circled = circle_highlighted(original_array,  binary_brain_final, 0.8)
