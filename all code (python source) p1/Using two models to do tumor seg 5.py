...
area_model_path1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/True area/Model 7"
area_model_path2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/True area/Model 6"
...
precise_model = keras.models.load_model(precise_model_path2)
...
precise_tumor_binary = combine_zeros(area_tumor_binary, precise_tumor_binary)
...
white_bumped_up[area_tumor_binary == 0] *= 0.5

write_images(white_bumped_up, output_image_path_Seg2)
...
correct = touching_island(correct, erode)

correct = dilate_up(correct, original_array, 5)

killed = kill_smaller_islands(correct, 0, 1000)


circled = circle_highlighted(original_array, killed, 1)
