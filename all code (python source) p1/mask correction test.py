...
brain_seg_model = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 63"
...
image_size = 128
index = 12
mask = get_folder_path("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/Brain-Tumor-Progression", index, "flair")


brain = highlight_ct(mask)
print('initialized')
brain.load_scan()
print('loaded scans')
