...
brain_seg_array[binary_brain == 0] *=0.2
...
tumor_seg_array[precise_tumor_binary == 0] = 0

print("median: " + str(brain.find_median_grayscale(tumor_seg_array)))
print("max: " + str(np.max(tumor_seg_array)))

binary = binarize2(original_array, brain.find_median_grayscale(tumor_seg_array), brain.find_median_grayscale(tumor_seg_array)+0.1)

erode = brain.erode_down(binary, 1)



correct = branch(precise_tumor_binary, erode, 5)
