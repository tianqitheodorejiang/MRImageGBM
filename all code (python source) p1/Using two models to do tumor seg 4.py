...
precise_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 13/Model 51"
area_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 13/Model 61"
brain_seg_model = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 3/Model 8"
...
binary_brain_area = binarize(brain_mask, 0.2)
...
precise_prediction = precise_model.predict(tumor_parts_precise)



precise_tumor_binary = binarize(precise_prediction, 0.6)
...
Max = np.max(area_prediction)

print("max: " + str(Max))

blurred_prediction = blur(area_prediction, 2)

threshed_prediction = adaptive_threshold(area_prediction, 25, 55)


area_tumor_binary = binarize(area_prediction, 0.3)
