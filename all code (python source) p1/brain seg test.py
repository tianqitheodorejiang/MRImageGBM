...
precise_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 10"
area_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 16/Model 41"
...
tumor_mask = tumor_seg.predict(brain_seg_area)
...
binary_tumor_area = binarize_max(tumor_mask, 0.1)

binary_tumor_area = combine_zeros(binary_tumor_area, binary_brain_area)
