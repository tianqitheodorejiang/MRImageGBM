...
brain_seg_model_precise = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 34"
...
brain_seg_precise = keras.models.load_model(brain_seg_model_precise)
...
final_brain_area_binary = dilate_up(final_brain_area_binary, blank, 2)
...
final_brain_area = final_brain_area/np.max(final_brain_area)
...
correct = touching_island(precise_binary_tumor, comed)

invert = brain.invert(correct)

not_highlighted = combine_zeros(binary_brain_area_patchup,invert)
not_highlighted = combine_zeros(not_highlighted, binary_brain_area2)

not_highlighted = brain.erode_down(not_highlighted, 1)

not_highlighted = touching_island(precise_binary_tumor, not_highlighted)
...
circled = circle_highlighted(circled, final_brain_area, 0.5)
