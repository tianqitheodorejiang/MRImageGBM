...
area_model_path1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/True area/Model 8"
...
white_bumped_up[area_binary_brain == 0] *= 0.5
