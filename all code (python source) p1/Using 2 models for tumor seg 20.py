...
precise_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 16/Model 51"
area_model_path = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Tumor Seg Model 16/Model 81"
brain_seg_model1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Brain Seg 4/Model 2"
brain_seg_model2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved Models/Model 34"
...
image_size = 128
index = 6
file = get_folder_path("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/TCGA-GBM", index, "flair")
...
#original_array = original_array/(np.max(blurred)*2)
...
brain_seg = keras.models.load_model(brain_seg_model1)

brain_mask = brain_seg.predict(original_array)

binary_brain_precise = binarize(brain_mask, 0.5)
binary_brain_area = binarize(brain_mask, 1)

brain_seg_array_area = combine_zeros(brain_seg_array_area, adapted)

binary_brain_area = kill_small_islands(brain_seg_array_area, 4)



brain_seg_array_precise[binary_brain_precise == 0] = 0
brain_seg_array_area[binary_brain_area == 0] = 0

tumor_parts_precise = brain_seg_array_precise.copy()
tumor_parts_area = brain_seg_array_area.copy()

tumor_parts_precise = tumor_parts_precise/np.max(tumor_parts_precise)
tumor_parts_area = tumor_parts_area/np.max(tumor_parts_area)


#brain_seg1 = keras.models.load_model(brain_seg_model1)

#brain_mask1 = brain_seg1.predict(original_array)


#binary_brain_precise = binarize(brain_mask1, 0.2)
...
precise_tumor_binary = binarize(precise_prediction, 0.9)


tumor_parts_precise[precise_tumor_binary == 0] = 0

median = find_median_grayscale(tumor_parts_precise)

print("median:" + str(median))


tumor_binary = binarize(original_array, (median*0.6))



area_model = keras.models.load_model(area_model_path)


area_prediction = area_model.predict(tumor_parts_area)



area_tumor_binary = binarize(area_prediction, 0.9)




correct = touching_island(precise_tumor_binary, area_tumor_binary)




circled = circle_highlighted(original_array, area_tumor_binary, 1)

#circled = circle_highlighted(circled, binary_brain_area, 0.8)
