...
brain_mask_area = combine_zeros(brain_mask_area12, binary_brain_area1)

brain_mask_area = dilate_up(brain_mask_area, blank, 5)


print("backsampling...")

mask_upscaled = skimage.transform.rescale(np.squeeze(brain_mask_area.copy()[0], axis = 3), (backscale_factor, backscale_factor, backscale_factor))
...
adapted = adaptive_threshold(original_unscaled_array, 21, 51)

brain1 = combine_zeros(adapted, brain_mask_precise_rescaled)

brain1 = kill_small_islands(brain1, 3)


#binary_brain_precise = combine_zeros(binary_brain_area, binary_brain_precise)





#where_the_brain_is = dilate_up(binary_brain_precise, blank, 5)


circled1 = circle_highlighted(original_array, brain_mask_area, 0.8)
#circled2 = circle_highlighted(original_array, area, 0.8)


write_images(circled1, output_image_path)
write_images(brain1, output_image_path_Seg)
