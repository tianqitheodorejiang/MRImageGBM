...
brain_seg_model = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 31 top view/Model 102.h5"

output_image_path = "/home/jiangl/Documents/python/ct to tumor identifier project/image ct  visualizations/Machine Learning 2 models test/Brain Seg OASIS 31 top view Model 102 wo median"
...
for i in range(0,20):
    ...
    #image_data = np.rot90(image_data, axes = (0,1))
    ...
    circled = circle_highlighted(original_unscaled_array, adapted, 1)

    both_mask_and_prediction = stick_at_end(circled, original_mask)
    
    
    if not os.path.exists((output_image_path + "/" + str(i*2))):
        os.makedirs((output_image_path + "/" + str(i*2)))
    else:
        shutil.rmtree((output_image_path + "/" + str(i*2)))
        os.makedirs((output_image_path + "/" + str(i*2)))
        
    write_images(both_mask_and_prediction, (output_image_path + "/" + str(i*2)))

    brain.generate_stl(adapted.T, ("/home/jiangl/Documents/python/ct to tumor identifier project/3d stl ct visualizations/" + os.path.basename(output_image_path)), str(i*2), 1)
