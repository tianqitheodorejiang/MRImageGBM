...
brain_seg_model_precise1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS/Model 52.h5"
brain_seg_model_precise2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS/Model 52.h5"
...
brain_seg_model_precise4 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 6/Model 91.h5"
...
image_size = 128
index = 0
file = get_folder_path("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/TCGA GBM DATA", index, "t1")
...
binary_brain_area = binarize(brain_mask1, 0.5)
...
binary_brain_area2 = binarize(brain_mask1, 0.05)
...
binary_brain_area2 = binarize(brain_mask1, 0.7)
...
binary_brain_area3 = binarize(brain_mask1, 0.7)


binary_brain_area2 = combine_zeros(binary_brain_area1, binary_brain_area2)
binary_brain_area2 = combine_zeros(binary_brain_area3, binary_brain_area2)
'''

brain_seg = keras.models.load_model(brain_seg_model_precise1)

new_array = original_array/(median/1)

brain_mask1 = brain_seg.predict(new_array)

binary_brain_area4 = binarize(brain_mask1, 0.8)


brain_seg = keras.models.load_model(brain_seg_model_precise4)
...
binary_brain_area3 = combine_zeros(binary_brain_area1, binary_brain_area2)




binary_brain_area_final = combine_white_binary(binary_brain_area4, binary_brain_area3)


mask_upscaled = skimage.transform.rescale(np.squeeze(binary_brain_area3.copy()[0], axis = 3), (backscale_factor, backscale_factor, backscale_factor))
...
brain_mask_precise_rescaled = dilate_up(brain_mask_precise_rescaled, blank, 1)


adapted1 = adaptive_threshold(original_unscaled_array, 11, 45, 1)

adapted = combine_zeros(adapted1, brain_mask_precise_rescaled)

#adapted = kill_small_islands(adapted, 1)

circled = circle_highlighted(original_unscaled_array, brain_mask_precise_rescaled, 1)



write_images(original_unscaled_array, output_image_path_Seg)

brain.generate_stl(adapted.T, "/home/jiangl/Documents/python/ct to tumor identifier project/3d stl ct visualizations", "brain new.stl", 1)
