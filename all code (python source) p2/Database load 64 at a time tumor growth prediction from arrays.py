    ...
    for n,set_ in enumerate(os.listdir(path)):
        try:
            if int(set_) not in bad_indexes:
                ...
                write_images(orig_mask, folder_output)
...
if data ==  main:
    get_files("C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/ACRIN-FMISO-Brain/loaded arrays",
              save_folder_path = "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/ACRIN-FMISO-Brain/Images and Masks For Tumor Segmentation")
