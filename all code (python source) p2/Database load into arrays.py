...
output_image_path = "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/image ct  visualizations/Machine Learning 2 models test/i dont really know why its not writing out images"
...
def get_files(path, start_index = 0, finish_index = False, img_id = "flair", save_folder_path = None, chunk_size = 64, image_size = 128):
    ...
    for i in range(start_index, finish_index):
        try:
            ...
            bounds_finder = adaptive_threshold(bounds_finder, 11, 45, 1)
            ...
            bounds_finder = adaptive_threshold(bounds_finder, 11, 45, 1, stacked = False)
            ...
            binary_brain_final_combined = translate_3d(binary_brain_final_combined, [-shallow,-low,-left])


            #save_array(binary_brain_final_combined, path + "/rough brain seg.h5")
            ...
            original_array_flair, binary_brain_final_combined = cut_neck(original_array_flair, binary_brain_final_combined)
            ...
            #save_array(original_array_flair, flair_path + "/original array.h5")

            circled = circle_highlighted(original_array_flair/(median_brain/0.35), binary_brain_final_combined, 1)
            ...
            write_images(circled, (output_image_path + "/" + str(i)))
