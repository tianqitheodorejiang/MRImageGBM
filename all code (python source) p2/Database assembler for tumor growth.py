...
output_path = "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/tumor progression with only flair and t1"
needs = ["flair", "t1prereg"]
deletes = []
sets_moved = 0
folders_moved = 0
