...
brain_seg_model_precise1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 10/Model 102.h5"
...
brain_seg_model_precise3 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 6/Model 91.h5"
...
new_array = original_array/(median/0.4)
...
binary_brain_area2 = binarize(brain_mask1, 0.8)

binary_brain_area = combine_zeros(binary_brain_area1, binary_brain_area2)


mask_upscaled = skimage.transform.rescale(np.squeeze(binary_brain_area.copy()[0], axis = 3), (backscale_factor, backscale_factor, backscale_factor))
