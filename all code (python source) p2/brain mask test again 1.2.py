...
brain_seg_model_precise1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 5/Model 91.h5"
...
adapted = adaptive_threshold(original_unscaled_array, 201, 201, 0)
...
brain_mask = branch(brain_mask, adapted, 3)
...
circled1 = circle_highlighted(original_unscaled_array, brain_mask_precise_rescaled, 0.8)
circled2 = circle_highlighted(original_unscaled_array, brain_mask, 0.8)
