...
brain_seg_model_precise1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS/Model 22.h5"
...
image_size = 128
index = 43
file = get_folder_path("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/Brain-Tumor-Progression", index, "t1")

print("\n\nSet:", index, "\n\n")

brain = highlight_ct("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/Brain-Tumor-Progression/PGBM-020/03-08-1990-FH-HEADBrain Protocols-70263/34903-T1prereg-50243")
print('initialized')
brain.load_scan()
print('loaded scans')
...
binary_brain_area2 = binarize(brain_mask1, 0.1)
...
adapted = adaptive_threshold(original_unscaled_array, 11, 45, 0)
...
brain_mask = dilate_up(brain_mask, blank, 1)

brain_mask = combine_zeros(brain_mask, adapted)



brain = highlight_ct("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/Brain-Tumor-Progression/PGBM-020/03-08-1990-FH-HEADBrain Protocols-70263/35742-FLAIRreg-10272")
print('initialized')
brain.load_scan()
print('loaded scans')
pixel = brain.generate_pixel_data()
