...
brain_seg_model_precise2 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 2/Model 101.h5"
...
new_array = original_array/(median/0.5)
...
binary_brain_area2 = binarize(brain_mask1, 0.9)


#binary_brain_area2 = kill_small_islands(binary_brain_area2, 1)
...
#brain_mask_precise_rescaled = dilate_up(brain_mask_precise_rescaled, blank, 2)



brain_seged = original_unscaled_array.copy()

brain_seged[brain_mask_precise_rescaled == 0] = 0
...
adapted = combine_zeros(adapted, brain_seged)
