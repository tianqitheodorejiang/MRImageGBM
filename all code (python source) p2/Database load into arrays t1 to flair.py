...
array_path = "C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/t1 to flair arrays"
...
def get_files(path, start_index = 0, finish_index = False, img_id = "flair", save_folder_path = None, chunk_size = 64, image_size = 128):
    ...
    for i in range(start_index, finish_index):
        try:
            ...
            original_array_top = np.stack([np.stack([original_array1], axis = 3)])


            original_array_front = np.stack([np.stack([np.rot90(original_array1, axes = (1,0))], axis = 3)])



            original_array_side = np.stack([np.stack([np.rot90(original_array1.T, axes = (1,2))], axis = 3)])




            brain_seg_top = keras.models.load_model(brain_seg_model_top)
            ...
            brain_seg_front = keras.models.load_model(brain_seg_model_front)
            ...
            brain_seg_side = keras.models.load_model(brain_seg_model_side)
            ...
            binary_brain_wo_median_combined = combine_zeros([binary_brain_top_top_ized, binary_brain_front_top_ized, binary_brain_side_top_ized])
            ...
            binary_brain_final_combined = combine_zeros([binary_brain_top_top_ized, binary_brain_front_top_ized, binary_brain_side_top_ized])
            ...
            save_array(original_array_flair, array_output_path + "/original array.h5")
...
if data ==  main:
    get_files("C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/TCGA and Tumor progression combined", img_id = "flair", 
