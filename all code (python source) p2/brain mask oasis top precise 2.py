...
brain_seg_model_precise1 = "/home/jiangl/Documents/python/ct to tumor identifier project/code files/Saved models/Brain Seg OASIS 6/Model 91.h5"
...
image_size = 128
index = 0
file = get_folder_path("/home/jiangl/Documents/python/ct to tumor identifier project/raw ct files/TCGA GBM DATA", index, "flair")
...
original_unscaled_array = original_unscaled_array/(median/5)
...
adapted1 = adaptive_threshold(original_unscaled_array, 45, 45, 1)
...
original_unscaled_array = original_unscaled_array/np.max(original_unscaled_array)
...
write_images(adapted1, output_image_path_Seg)
