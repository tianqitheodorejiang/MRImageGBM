...
def get_files(path, img_id = "flair", mask_id = "seg", save_folder_path = None,image_size = 128, start_index = 0):
    ...
    for path, dirs, files in os.walk(path, topdown=False):
        for dirr in dirs:
            ...
            for file in os.listdir(set_path):
                ...
                if img_id in file:
                    usable+=1
                    img_path = os.path.join(set_path, file)
            if usable == 2:
    ...
    for i in range(start_index, num_files):
        ...
        channeled_mask[mask<4.5] = 4
        channeled_mask[mask<2.5] = 2
        channeled_mask[mask<1.5] = 1
        channeled_mask[mask<0.5] = 0
        ...
        save_array(flair, array_output_path + "/original array.h5")
...
get_files("C:/Users/JiangQin/Documents/python/ct to tumor identifier project/raw ct files/MICCAI_BraTS_2019_Data_Training", img_id = "flair",
